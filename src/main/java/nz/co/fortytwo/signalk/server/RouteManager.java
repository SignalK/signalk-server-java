...
public class RouteManager extends RouteBuilder {
    ...
    private void reloadCharts() {
        ...
        // Get the branch with the charts
        TreeMap treeMap = new TreeMap(signalkModel.getSubMap("resources.charts"));
    ...
    /**
     * When the serial port is used to read from the arduino this must be called
     * to shut down the readers, which are in their own threads.
     */
