...
public class StompTest extends SignalKCamelTestSupport{
	...
	public void testSubscribe() throws Exception {
		...
		connection.subscribe("/queue/signalk."+uuid+".vessels.motu.navigation", Subscribe.AckModeValues.AUTO);
	...
	public void testSendingUpdate() throws Exception {
		...
		//headers.put(WebsocketConstants.CONNECTION_KEY, uuid);
		connection.send("/queue/signalk.put", FileUtils.readFileToString(new File("src/test/resources/samples/windAngleUpdate.json.txt")));
