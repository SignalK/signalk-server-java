...
public class WebsocketTest3 extends SignalKCamelTestSupport {
	...
	@Test
    public void shouldReceiveSubscribedMsg() throws Exception {
      ...
      //subscribe
        Response reponse = c.prepareGet("http://localhost:9290"+SIGNALK_SUBSCRIBE+"/vessels/"+SELF+"/navigation/log").setCookies(cookies).execute().get();
