...
Try http://localhost:9290/signalk/api/vessels to see some output. You can drill down by adding json fields, eg http://localhost:9290/signalk/api/vessels/367153070 or http://localhost:9290/signalk/api/vessels/motu
